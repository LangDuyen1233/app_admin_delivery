...
class DeliveringScreen extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _DeliveringScreen();
  }
}

RxList<Order> listOrder;

class _DeliveringScreen extends State<DeliveringScreen> {
  @override
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                              ...
                              child: InkWell(
                                onTap: () async {
                                  await delivered(listOrder[index].id);
                                  setState(() {
  ...
  Future<List<Order>> getOrder() async {
    ...
    try {
      print(Apis.getDeliveringCardUrl);
      http.Response response = await http.get(
        Uri.parse(Apis.getDeliveringCardUrl),
  ...
  Future<Order> delivered(int id) async {
    String token = await getToken();
    print(token);
    try {
      EasyLoading.show(status: 'Loading...');
      http.Response response = await http.post(
        Uri.parse(Apis.deliveredUrl),
        headers: <String, String>{
